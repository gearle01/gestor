...
export default function PublicBooking() {
    ...
    return (
        <div className="h-screen w-full bg-gray-100 flex items-center justify-center p-2 sm:p-4 font-sans">
            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col h-full sm:h-auto sm:max-h-[90vh]">

                {/* HEADER */}
                <div className="bg-gradient-to-b from-blue-600 via-blue-600 to-blue-700 text-white px-6 pt-safe-top pb-8 rounded-b-4xl relative overflow-hidden">
                    {/* Gradient overlay para preencher notch */}
                ...
                {step === 3 && selectedDate && selectedTime && (
                    <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-200 p-4 space-y-3">
